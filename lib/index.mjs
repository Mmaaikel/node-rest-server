...
var NodeRestServer = function NodeRestServer(routeConfig) {
  ...
  try {
    var _serverConfig$middlew;

    var usePhusionPassengerListen = (serverConfig === null || serverConfig === void 0 ? void 0 : serverConfig.passenger) === true; // Plesk fix

    var hasPhusionPassenger = usePhusionPassengerListen && typeof PhusionPassenger != 'undefined';
    ...
    var customMiddleWares = (_serverConfig$middlew = serverConfig === null || serverConfig === void 0 ? void 0 : serverConfig.middlewares) !== null && _serverConfig$middlew !== void 0 ? _serverConfig$middlew : [];

    if (customMiddleWares.length > 0) {
      for (var customMiddleware in customMiddleWares) {
